...
const BOT_NAME = process.env.BOT_NAME || "x - ʟɪᴛᴇ";
const OWNER_NAME = process.env.OWNER_NAME || "ᴀᴋɪɴᴅᴜ ᴍᴅ";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "_sᴛᴀᴛᴜs sᴇᴇɴ ʙʏ x ʟɪᴛᴇ_";
const DEV = process.env.DEV || 'ᴀᴋɪɴᴅᴜ ᴍᴅ';
...
> ꜱᴛᴀʏ ᴡɪᴛʜ x - ʟɪᴛᴇ ʙᴏᴛ ɴᴇᴡ ᴜᴘᴅᴀᴛᴇ
                    `;
